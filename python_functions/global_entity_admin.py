...
def admin_dashboard(flask_app):
    ...
    global_admin = dash.Dash(__name__,
                             server=flask_app,
...
html.Div([
    ...
    html.Div([
        # Section 1: Images
        html.Div([
             html.Img(src="main_converted.png", alt="Main Converted Image", className='small-image'),  # Image with alt text
                ...
                html.Div([  # Data Container
                    ...
                    # First row: Two charts side by side
                        html.Div([
                            ...
                            dcc.Graph(id='factory-activities', className='chart',style={'margin-left':'1%','margin-top':'-75px'}),
    ...
    def update_dashboard(statusClickData, regulationClickData,criticalityClickData, 
        ...
        color_map = {
            ...
            'Yet to Start': '#5C63F2',  # Dark Purple
        }
    ...
    #     df_monthly_task_count['month'] = df_monthly_task_count['month'].astype(str)
        ...
        task_count_df = df.groupby(['Entity', 'regulation_name']).size().reset_index(name='Task')
        ...
        status_distribution_donut = px.pie(
            ...
            width=500,  # Adjust the width to fit better
        ...
        status_distribution_donut.update_layout(
            ...
            margin=dict(l=10, r=40, t=20, b=40),  # Remove all margins
            paper_bgcolor='rgba(0,0,0,0)',  # Transparent background (paper)
        ...
        status_distribution_bar.update_layout(
            ...
            legend=dict(
                ...
                yanchor="bottom",
                y=-0.2,  # Positioning the legend below the chart
                xanchor="center",
                x=0.5,
                font=dict(size=9)
            )
        ...
        # If "status-distribution-bar" was clicked
            ...
            factory_filtered_df = df[df['Entity'] == clicked_regulation]
            ...
            print(clicked_regulation,'is regulation')
            filtered_df = df[(df['Entity'] == clicked_regulation) &(df['regulation_name'] == matched_status)]
            columns = [
                {'name': 'Regulation', 'id': 'regulation_name'},
                {'name': 'Task', 'id': 'Task'},
                {'name': 'Status', 'id': 'calculated_status'}  # Include status in the table
